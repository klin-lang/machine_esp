...
P4 Pin [114](https://github.com/klin-lang/klin/blob/main/issues/114-machine-esp-esp32-p4.md).
...
| **ESP32-P4** | `pin_out_p4` / `pin_in_p4` | later | later | later | later | later | later | later | — | `blink_p4` | ESP-IDF v5.x |
...
| Item | C3 | S3 | P4 |
|---|---|---|---|
| Factories | `pin_out`, `pwm_out`, … | `pin_out_s3`, … | `pin_out_p4` / `pin_in_p4` |
...
Pwm/Uart/… `*_p4` later. RMII Ethernet → [`esp_eth`](https://github.com/klin-lang/esp_eth) [104] E1 (not this package).
...
Host tests cover baud/div/base/scale math, S3/P4 pin maps, UART/ADC maps, and RMT
